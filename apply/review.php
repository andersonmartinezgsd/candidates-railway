...
function showFinalSuccess() {
  ...
  const BOT_PHONE = "573113083169"; // El número que aparece en tus capturas
  ...
  el.innerHTML = `
    ...
    <div style="padding:4rem 2rem;text-align:center;">
      ...
      <p style="color:rgba(255,255,255,0.5);font-size:0.88rem;line-height:1.7;max-width:400px;margin:0 auto 1.75rem;">
        Everything is ready! To finalize your process and receive your confirmation, please click the button below to return to WhatsApp.
      </p>
