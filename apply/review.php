...
function showFinalSuccess() {
  ...
  el.innerHTML = `
    ...
    <div style="padding:4rem 2rem;text-align:center;">
      ...
      <h2 style="color:#fff;font-size:1.85rem;font-weight:900;margin:0 0 .6rem;letter-spacing:-.04em;">Application Completed!</h2>
      <p style="color:rgba(255,255,255,0.5);font-size:0.88rem;line-height:1.7;max-width:420px;margin:0 auto .75rem;">
        Your application has been completed successfully. Please click the button below to confirm the final step on WhatsApp.
      </p>
      <p style="color:rgba(255,255,255,0.72);font-size:0.8rem;line-height:1.6;max-width:420px;margin:0 auto 1.75rem;font-weight:700;">
        Support line: +1 (510) 214-3287
      </p>
      ...
      <br><br>
      <a href="${BASE_URL}views/new-candidate.php?token=${TOKEN}" target="_blank"
         style="color:rgba(255,255,255,0.3);text-decoration:none;font-size:0.65rem;text-transform:uppercase;letter-spacing:0.1em;">
